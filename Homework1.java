...
public class Homework1{
   ...
   public static void main (String [] args) {
       ...
       if (option == 1){
           System.out.println("Print name of shop: ");
           ...
           Store str = new Store(storeName, goodsName, productPrice, quantityOfGoods, storeSection);
       ...
       if (option == 2){
           ...
           System.out.println("Print name of goods: ");
            ...
            FlowerShop fwl = new FlowerShop(storeName, flowerName, condition, goodsName, productPrice, quantityOfGoods, storeSection);
       ...
       if (option == 3){
           ...
           System.out.println("Print name of goods: ");
            ...
            Boutique btq = new Boutique(storeName, cloth, size, flowerName, condition, goodsName, productPrice, quantityOfGoods, storeSection);
