...
public class FlowerShop extends Store{
    ...
    private String flowerName, condition;
     ...
     public FlowerShop(String storeName, String flowerName, String condition, String goodsName, int productPrice, int quantityOfGoods, String storeSection) {
        super(storeName, goodsName, productPrice, quantityOfGoods, storeSection);
    ...
    public String toString() {
        return ("Name of shop" + getName() + "  Product: " + getNameOfGoods() + " Price: " + getProductPrice() + " Quantity: " + 
